var init = function () {
  ...
  var texture = textureLoader.load(texturepath + "stone.jpg");
  var mat = new THREE.MeshPhongMaterial();
  mat.map = texture;
  var kawa1_texture = textureLoader.load(texturepath + "kawa1.jpg");
  var kawa1_mat = new THREE.MeshLambertMaterial();
  kawa1_mat.map = kawa1_texture;
  var kawa2_texture = textureLoader.load(texturepath + "kawa2.jpg");
  var kawa2_mat = new THREE.MeshLambertMaterial();
  kawa2_mat.map = kawa2_texture;
  var minamo_texture = textureLoader.load(texturepath + "minamo.jpg");
  var minamo_mat = new THREE.MeshPhongMaterial();
  minamo_mat.map = minamo_texture;
  var ki_texture = textureLoader.load(texturepath + "ki.jpg");
  var ki_mat = new THREE.MeshLambertMaterial();
  ki_mat.map = ki_texture;
  var tree_texture = textureLoader.load(texturepath + "tree0.png");
  var tree2_texture = textureLoader.load(texturepath + "tree1.png");
  var tree3_texture = textureLoader.load(texturepath + "tree2.png");
  var tree4_texture = textureLoader.load(texturepath + "tree3.png");

  //バンプマップ読み込み
  var bump = textureLoader.load(texturepath + "stone-bump.jpg");
  mat.bumpMap = bump;
  mat.bumpscale = 0.2;
  ...
  tree2plane.position.set(-35.5, -1, -1);
  ...
  fire2.mesh.position.set(-40, 3, 40);
  ...
  fire3.mesh.position.set(40, 3, -40);
  ...
  fire4.mesh.position.set(-40, 3, -40);
